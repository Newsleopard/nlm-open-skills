...
將 `newsleopard-api/` 資料夾複製到對應的 Skills 目錄即可。
...
```bash
cp -r newsleopard-api/ <your-project>/.claude/skills/newsleopard-api/
```

**全域安裝**（所有專案皆可使用）：

```bash
cp -r newsleopard-api/ ~/.claude/skills/newsleopard-api/
```
...
```bash
cp -r newsleopard-api/ <your-project>/.github/skills/newsleopard-api/
```

**全域安裝：**

```bash
cp -r newsleopard-api/ ~/.copilot/skills/newsleopard-api/
```
...
```bash
cp -r newsleopard-api/ <your-project>/.cursor/skills/newsleopard-api/
```

**全域安裝：**

```bash
cp -r newsleopard-api/ ~/.cursor/skills/newsleopard-api/
```
...
```bash
cp -r newsleopard-api/ <your-project>/.windsurf/skills/newsleopard-api/
```

**全域安裝：**

```bash
cp -r newsleopard-api/ ~/.codeium/windsurf/skills/newsleopard-api/
```
...
```bash
cp -r newsleopard-api/ <your-project>/.agents/skills/newsleopard-api/
```

**全域安裝：**

```bash
cp -r newsleopard-api/ ~/.agents/skills/newsleopard-api/
```

**系統級安裝：**

```bash
sudo cp -r newsleopard-api/ /etc/codex/skills/newsleopard-api/
```
...
```bash
cp -r newsleopard-api/ <workspace>/skills/newsleopard-api/
```

**全域安裝：**

```bash
cp -r newsleopard-api/ ~/.openclaw/skills/newsleopard-api/
```
